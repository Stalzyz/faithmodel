         ...
         <div className="mt-12 space-y-4 max-w-4xl">
            {documents.map((doc, i) => (
               <SketchReveal key={i} delay={i * 0.05}>
                  <div className="flex items-center justify-between p-4 border border-[rgba(74,74,94,0.1)] hover:border-[#FB7F05] transition-colors group">
                     <span className="font-inter text-sm text-[#4a4a5e] group-hover:text-[#1a1a2e]">{doc}</span>
                     <a href="#" className="font-poppins text-xs font-semibold text-[#1a1a2e] px-4 py-2 bg-[rgba(74,74,94,0.05)] group-hover:bg-[#FB7F05] transition-colors shrink-0 ml-4">View PDF</a>
                  </div>
               </SketchReveal>
            ))}
         </div>
