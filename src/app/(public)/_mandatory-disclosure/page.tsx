      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-8 pb-16 border-b border-[rgba(74,74,94,0.08)]">
        <SketchReveal>
          ...
          <h1 className="font-cormorant text-[clamp(3rem,7vw,6rem)] font-light text-[#1a1a2e] leading-[1.08] tracking-tight max-w-4xl">
            Mandatory Public<br /><em className="text-[#FB7F05] not-italic">Disclosure</em>
          </h1>
        </SketchReveal>
      </div>
         ...
         <div className="mt-12 space-y-4">
            {documents.map((doc, i) => (
               <SketchReveal key={i} delay={i * 0.05}>
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between p-5 bg-white border border-[rgba(74,74,94,0.12)] rounded-2xl shadow-xs hover:border-[#FB7F05] transition-all group gap-4">
                     <div className="flex items-center gap-3.5 min-w-0">
                        <div className="w-10 h-10 rounded-full bg-[#FB7F05]/10 flex items-center justify-center shrink-0 text-[#FB7F05] group-hover:bg-[#FB7F05] group-hover:text-white transition-colors">
                     ...
                     <a href={doc.file} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 font-poppins text-xs font-semibold text-white px-5 py-2.5 bg-[#1a1a2e] hover:bg-[#FB7F05] rounded-full transition-all shrink-0 shadow-xs">
                        <span>View PDF</span>
