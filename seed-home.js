...
async function main() {
  ...
  await prisma.page.upsert({
    ...
    update: {
      title: 'Home',
      content: JSON.stringify({ blocks, seo: { title: "Faith Model School", description: "Empowering minds, shaping futures since 1989." } }),
      isPublished: true
    },
    create: {
      title: 'Home',
  ...
  console.log('Successfully seeded the home page with CMS blocks!');
}
